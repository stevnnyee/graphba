    ...
    <AnimatePresence mode="wait">
      {profile && (
        <motion.aside
          ...
          className="glass pointer-events-auto absolute top-28 right-4 z-10 w-72 rounded-2xl p-5"
        >
          ...
          <div className="mt-5">
            <p className="mb-2 text-[11px] tracking-wider text-white/35 uppercase">
              Teams
            </p>
